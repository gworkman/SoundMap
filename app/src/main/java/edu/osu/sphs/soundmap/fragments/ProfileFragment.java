...
public class ProfileFragment extends Fragment implements OnMapReadyCallback {
    ...
    private ArrayList<DataPoint> recordings = new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecordingListAdapter(this.context, this.recordings);
        recycler.setAdapter(adapter);
        recycler.setLayoutManager(new LinearLayoutManager(this.context));
        recycler.addItemDecoration(new DividerItemDecoration(this.context, DividerItemDecoration.VERTICAL));
    }
